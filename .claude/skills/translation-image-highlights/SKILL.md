...
如果英文是 `winds, beguiled into loitering`，中文译成“风儿被诱得徘徊不去”：
- `beguiled` 应优先对应“诱得”这类最小准确表达
- `loitering` 应对应“徘徊”或“徘徊不去”
- 不要因为中文把两个动作重组了，就按英文顺序生硬切分或放弃标注
...
8. **英文先保底**，只要英文 panel 中能定位到该词，就不要因为中文难配而丢掉英文标注
